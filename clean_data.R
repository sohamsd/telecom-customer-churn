...
dataset$SeniorCitizen[dataset$SeniorCitizen == 1] = 'Yes'
dataset$SeniorCitizen[dataset$SeniorCitizen == 0] = 'No'
dataset$Partner <- revalue(dataset$Partner, c('Yes' = 'Married', 'No' = 'Single'))
...
dataset$Churn[dataset$Churn == 'No'] = 'Retained'
dataset$Churn[dataset$Churn == 'Yes'] = 'Churned'
...
churn <- filter(dataset, Churn == 'Churned')
non_churn <- filter(dataset, Churn == 'Retained')
